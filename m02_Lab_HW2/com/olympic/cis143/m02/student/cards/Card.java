...
/**
 * Class to hold information about the Card. Cards are held in decks and have a 
 * Suit and value.
 *
 * Note that jokers are created with a suit of NONE. 
 * Note that, other than joker cards, NONE should not ever be a suit.
 */
public class Card {
